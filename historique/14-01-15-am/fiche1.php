    	   ...
    	   <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 mainnav">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#">AIDE</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Fiche <b class="caret"></b></a>
   ...
   <hr>
     <div class="container">
			 ...
			 <form id="form" method="POST" action="courige1.php">
			  ...
			  <div class="row">  
                                <div class="col-md-12 col-xs-12"><p class="prof label-info label_activite">a. Qui est l'expéditeur de ce courrier électronique aussi appelé courriel ?</p></div>
								<div class="col-md-4 col-xs-12">
                                       <div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="exped" id="exped1" value="À un proche" />
                                    </span><label for="exped1" class="form-control">Un homme</label></div></div>
								<div class="col-md-4 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="exped" id="exped2" value="À des professionnels" />
                                    </span><label for="exped2" class="form-control">Une femme</label></div></div>
								<div class="col-md-4 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="exped" id="exped3" value="À une personnalité" />
                                    </span><label for="exped3" class="form-control">On ne sait pas</label></div></div>
				</div></br> 
								
				<div class="row">  
                                <div class="col-md-12 col-xs-12"><p class="prof label-info label_activite">b. Que propose-t-on à Mohammed RAÏS ?</p></div>
								<div class="col-md-4 col-xs-12">
                                       <div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="propos" id="propos1" value="À un proche" />
                                    </span><label for="propos1" class="form-control">On lui propose une brochure</label></div></div>
								<div class="col-md-4 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="propos" id="propos2" value="À des professionnels" />
                                    </span><label for="propos2" class="form-control">On lui fait une proposition commerciale</label></div></div>
								<div class="col-md-4 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="propos" id="propos3" value="À une personnalité" />
                                    </span><label for="propos3" class="form-control">On lui indique qu'un conseiller commercial va le contacter</label></div></div>
			</div> 
                ...
                <div class="well well-lg">
                    ...
                    <h2>Remise en ordre.</h2><br>
                    <p><strong>Glissez et déposez</strong> les éléments dans la bon ordre pour en faire <strong>un courriel</strong>.</p>
                                                 
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                <ol class="phrases vertical encours">
                    <li value="3"><i class="fa fa-arrows"></i> <strong>Développement</strong> : votre conseiller commercial aura le privilège de...</li>
                    <li value="4"><i class="fa fa-arrows"></i> <strong>Objet</strong> : offre commerciale</li>
                    <li value="1"><i class="fa fa-arrows"></i> <strong>Rappel du contexte</strong> : faisant suite à...</li>
                    <li value="6"><i class="fa fa-arrows"></i> <strong>Remerciement</strong> : nous vous remercions pour...</li>          
                    <li value="2"><i class="fa fa-arrows"></i> <strong>Salutations</strong> : cordialement</li>
                    <li value="5"><i class="fa fa-arrows"></i> <strong>Formule d’appel</strong> : bonjour</li>  
                    <li value="7"><i class="fa fa-arrows"></i> <strong>Signature</strong> : service commercial</li>     
                </ol>
				<input type="text" id="ordre" class="hidden" name="reponse" /> </br></br>
			</div>
            </div><!--fin activité 2-->
			...
			<div class="well well-lg">
                    ...
                    <p>Objet : Re : offre commerciale</p>
									<div class="input-group">
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon label_activite">Formule d’appel :
												</span>
										...
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon label_activite">Rappel du contexte :	
												</span>		
										...
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon label_activite">Développement :	
												</span>		
										...
										</div>d’acquérir un véhicule de votre marque en bénéficiant des remises annoncées.
					...
					<p>Cependant, je souhaiterais savoir dans quelle mesure je serais susceptible de pouvoir bénéficier d’un prêt bancaire auprès de votre compagnie.</p>					
										...
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon label_activite">Remerciement : 	
												</span>		
										...
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon label_activite">Salutations 	
												</span>		
            ...
            <div class="well well-lg">                            
                                <div class="row">  
                                <div class="col-md-3 col-xs-12"><p class="label-info label_activite">Sentiments respectueux</p></div>
								<div class="col-md-3 col-xs-12">
                                       <div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="sentim" id="sentim1" value="À un proche" />
                                    </span><label for="sentim1" class="form-control">À un proche </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="sentim" id="sentim2" value="À des professionnels" />
                                    </span><label for="sentim2" class="form-control">À des professionnels </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="sentim" id="sentim3" value="À une personnalité" />
                                    </span><label for="sentim3" class="form-control">À une personnalité </label></div></div>
								</div></br>
								...
								<div class="col-md-3 col-xs-12">
                                    ...
                                    </span><label for="cord1" class="form-control">À un proche </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="cord" id="cord2" value="À des professionnels" />
                                    </span><label for="cord2" class="form-control">À des professionnels </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="cord" id="cord3" value="À une personnalité" />
                                    </span><label for="cord3" class="form-control">À une personnalité </label></div></div>
								</div></br>
                               ...
                               <div class="row">  
								...
								<div class="col-md-3 col-xs-12">
                                    ...
                                    </span><label for="alap1" class="form-control">À un proche </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="alap" id="alap2" value="À des professionnels" />
                                    </span><label for="alap2" class="form-control">À des professionnels </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="alap" id="alap3" value="À une personnalité" />
                                    </span><label for="alap3" class="form-control">À une personnalité </label></div></div>
								</div></br>
								...
								<div class="col-md-3 col-xs-12">
                                    ...
                                    </span><label for="cors1" class="form-control">À un proche </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="cors" id="cors2" value="À des professionnels" />
                                    </span><label for="cors2" class="form-control">À des professionnels </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="cors" id="cors3" value="À une personnalité" />
                                    </span><label for="cors3" class="form-control">À une personnalité </label></div></div>
								</div></br>

                               <div class="row">  
                                <div class="col-md-3 col-xs-12"><p class="prof label-info label_activite">Respectueuse considération</p></div>
								<div class="col-md-3 col-xs-12">
                                       <div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="resp" id="resp1" value="À un proche" />
                                    </span><label for="resp1" class="form-control">À un proche </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="resp" id="resp2" value="À des professionnels" />
                                    </span><label for="resp2" class="form-control">À des professionnels </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="resp" id="resp3" value="À une personnalité" />
                                    </span><label for="resp3" class="form-control">À une personnalité </label></div></div>
								</div></br>
								...
								<div class="col-md-3 col-xs-12">
                                    ...
                                    </span><label for="ss1" class="form-control">À un proche </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="ss" id="ss2" value="À des professionnels" />
                                    </span><label for="ss2" class="form-control">À des professionnels </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="ss" id="ss3" value="À une personnalité" />
                                    </span><label for="ss3" class="form-control">À une personnalité </label></div></div>
								</div></br>
								...
								<div class="col-md-3 col-xs-12">
                                    ...
                                    </span><label for="sd1" class="form-control">À un proche </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="sd" id="sd2" value="À des professionnels" />
                                    </span><label for="sd2" class="form-control">À des professionnels </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="sd" id="sd3" value="À une personnalité" />
                                    </span><label for="sd3" class="form-control">À une personnalité</label></div></div>
								</div></br>
                               ...
                               <div class="row">  
								...
								<div class="col-md-3 col-xs-12">
                                    ...
                                    </span><label for="bs1" class="form-control">À un proche </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="bs" id="bs2" value="À des professionnels" />
                                    </span><label for="bs2" class="form-control">À des professionnels </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="bs" id="bs3" value="À une personnalité" />
                                    </span><label for="bs3" class="form-control">À une personnalité </label></div></div>
								</div></br> 
								...
								<div class="col-md-3 col-xs-12">
                                    ...
                                    </span><label for="a1" class="form-control">À un proche </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="prof input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="a" id="a2" value="À des professionnels" />
                                    </span><label for="a2" class="form-control">À des professionnels </label></div></div>
								<div class="col-md-3 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="a" id="a3" value="À une personnalité" />
                                    </span><label for="a3" class="form-control">À une personnalité </label></div></div>
								</div></br> 
								

          </div><!--fin activité 5--></br>
							    <button class="btn btn-success btn-md pull-right" type="submit" hidden="hidden">
                        <i class="fa fa-check-circle"> </i> Voir le corrigé</button><br>
        ...
        <div class="container bottombar">
            ...
            <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 ">
                ...
                <span><a href="#">ACCUEIL</a>
                    <a href="#">SITE OFFICIEL DE L'INSTITUT FRANÇAIS</a>
