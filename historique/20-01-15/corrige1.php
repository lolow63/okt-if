                       ...
                       if ($_POST){
                        ...
                        if($repAZ=='1234567'){$ok ='true' ;} else {$ok;}
						 ...
						 echo'</div>';
						  ...
						  if($ok =='true'){echo'<p><span class="fa fa-2x fa-check"></span> <strong class="bonrep">C\'est correct !</strong></p>';}
						  else{echo '<p><span class="fa fa-2x fa-close"></span> <strong class="mauvrep">Hum, ce n\'est pas tout à fait ça...</strong></p>';
								  ...
								  echo $ligne7;
							echo'</div>';
							echo' <p><br/>Retenez bien cet ordre d\'étapes, dans la plupart des cas les courriels sont organisés de cette façon.</p>';
								 }?>
