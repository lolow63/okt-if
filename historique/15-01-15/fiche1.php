...
<html>
    ...
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Fiche 1</a>
      </div>
...
<!--FIN CODE BARRE DE NAVIGATION TOP-FIXE-->
    <div class="header">
            <div class="container">
  ...
  <i class="fa fa-trash-o fa-lg"></i> Supprimer</a>
			 ...
			 <form id="form" method="POST" action="courige1.php">
			  ...
			  <div class="row">  
								...
								<div class="col-md-4 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="exped" id="exped2" value="À des essionnels" />
				...
				<div class="row">  
								...
								<div class="col-md-4 col-xs-12"><div class=" input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="propos" id="propos2" value="À des essionnels" />
                ...
                <div class="well well-lg col-xs-12 col-sm-12 col-md-5">
                    ...
                    <p>Replacez les éléments dans le <strong>bon ordre</strong> à l'aide d'un <i>glisser-déposer</i>.</p>
                                                 
            </div>
            <div class="well well-lg col-xs-12 col-sm-12 col-md-offset-1 col-md-6">
                <ol class="phrases vertical encours">
                    <li value="3"><i class="fa fa-arrows-v"></i> <strong>Développement</strong> : votre conseiller commercial aura le privilège de...</li>
                    <li value="4"><i class="fa fa-arrows-v"></i> <strong>Objet</strong> : offre commerciale</li>
                    <li value="1"><i class="fa fa-arrows-v"></i> <strong>Rappel du contexte</strong> : faisant suite à...</li>
                    <li value="6"><i class="fa fa-arrows-v"></i> <strong>Remerciement</strong> : nous vous remercions pour...</li>          
                    <li value="2"><i class="fa fa-arrows-v"></i> <strong>Salutations</strong> : cordialement</li>
                    <li value="5"><i class="fa fa-arrows-v"></i> <strong>Formule d’appel</strong> : bonjour</li>  
                    <li value="7"><i class="fa fa-arrows-v"></i> <strong>Signature</strong> : service commercial</li>     
                </ol>
				<input type="text" id="ordre" class="hidden" name="reponse" /> 
			</div>
            <!--fin activité 2-->


			<h3 id="act3" class="activite">Activité 3</h3>
			<p><i>Utilisez la bonne expression :</i></p>
			...
			<div class="well well-lg">					 
								...
								<div class="input-group">
											...
											<div class="input-group">
												<span class="input-group-addon label_activite">Un médecin :
													...
													<select name="medcin" class="form-control">
														<option VALUE="vous n'avez pas répondu"> </option>                                
        	                                            <option VALUE="esseur">esseur</option>
		                                                <option VALUE="Maître">Maître</option>
								 ...
								 <h3 id="act5" class="activite">Activité 5</h3>
            ...
            <div class="well well-lg">                            
								...
								<div class="col-md-3 col-xs-12"><div class=" input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="cord" id="cord2" value="À des essionnels" />
                               ...
                               <div class="row">  
								...
								<div class="col-md-3 col-xs-12"><div class=" input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="alap" id="alap2" value="À des essionnels" />
								...
								<div class="col-md-3 col-xs-12"><div class=" input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="cors" id="cors2" value="À des essionnels" />
                               ...
                               <div class="row">  
								...
								<div class="col-md-3 col-xs-12"><div class=" input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="resp" id="resp2" value="À des essionnels" />
								...
								<div class="col-md-3 col-xs-12"><div class=" input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="ss" id="ss2" value="À des essionnels" />
								...
								<div class="col-md-3 col-xs-12"><div class=" input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="sd" id="sd2" value="À des essionnels" />
                               ...
                               <div class="row">  
								...
								<div class="col-md-3 col-xs-12"><div class=" input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="bs" id="bs2" value="À des essionnels" />
								...
								<div class="col-md-3 col-xs-12"><div class=" input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="a" id="a2" value="À des essionnels" />
