    	   ...
    	   <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 mainnav">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="intro.html">INTRODUCTION
					</a></li>
                    <li><a href="#">LIEN</a></li>
                </ul>
...
Cordialement.</br> 
Service commercial VEH</p><div id="act1"></div>
            </div>
            <div class="list-group-item">
		...
		<div class="container">
			...
			<div class="list-group-item">
				...
				<ul class="list-unstyled">Chaque fiche est structurée de la façon suivante :
					...
					<li><span class="fa fa-angle-double-right"></span> Des activités en rapport au courriel.</li>
					<li><span class="fa fa-angle-double-right"></span> Un corrigé apportant des éclaircissements en rapport avec vos réponses.</li>
			...
			<div class="well">
				<p class="alinea">Par la richesse de ses contenus, son ergonomie et son aspect dynamique, cette formation en ligne de l’IFA vous aidera à acquérir et développer des compétences, nécessaires pour la bonne conduite de vos projets en entreprise.</p>
						...
						<div class="buttons pull-right">
                            <a href="intro.html"class="btn btn-formation">M'inscrire gratuitement</a>
						</div> 
        ...
        <div class="container bottombar">
            ...
            <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 ">
                ...
                <span><a href="index.html">ACCUEIL</a>
                    <a href="http://www.if-algerie.com">SITE OFFICIEL DE L'INSTITUT FRANÇAIS D'ALGÉRIE</a>
