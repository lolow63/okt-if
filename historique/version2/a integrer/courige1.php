				 ...
				 <h2>Corrigé de la fiche N°1</h2></br>
					 ...
					 <?php
                       ...
                       if ($_POST){
                       	  ...
                       	  $a=($_POST['a']);
                       	  $rapp=($_POST['rapp']);
						  $repAZ = str_replace(',', '', $_POST['reponse']);
                          $notrap=0;$repp='faux';
                        ...
                        if($repAZ=='1234567'){$ok ='true' ;} else {$ok;}
                         ...
                         echo'<p class="remarque"> Il s\'agit ici de remises dans le cadre d\'une opération promotionnelle à durée limitée (le mois). La condition pour en bénéficier étant de répondre à l\'offre avant le 30 mars.</p>';
                           //activié2
						   //on declare les ligne:
						          $ligne1='<li value="1"><i class="fa fa-arrows"></i> <strong>Objet</strong> : offre commerciale</li>';
								  $ligne2='<li value="2"><i class="fa fa-arrows"></i> <strong>Formule d’appel</strong> : bonjour</li>';
								  $ligne3='<li value="3"><i class="fa fa-arrows"></i> <strong>Rappel du contexte</strong> : faisant suite à...</li>';
								  $ligne4='<li value="4"><i class="fa fa-arrows"></i> <strong>Développement</strong> : votre conseiller commercial aura le privilège de...</li>';
								  $ligne5='<li value="5"><i class="fa fa-arrows"></i> <strong>Remerciement</strong> : nous vous remercions pour...</li>';
                                  $ligne6='<li value="6"><i class="fa fa-arrows"></i> <strong>Salutations</strong> : cordialement</li>';
					              $ligne7='<li value="7"><i class="fa fa-arrows"></i> <strong>Signature</strong> : service commercial</li>'; 
						   
                          echo'<h3 class="activite">Activité 2</h3>';
						  echo'<p>vous avez rependu</p>';
						          //ligne1      
						  ...
						  if($ok =='true'){echo'<p> <strong class="bonrep">C\'est correct !</strong></p>';}
						  else{echo '<p> <strong class="mauvrep">Hum, ce n\'est pas tout à fait ça</strong></p>';
						  echo' <p>Retenez bien cet ordre d\'étapes, dans la plupart des cas les courriels sont organisés de cette façon.</p>';
						          echo $ligne1;
								  echo $ligne2;
								  echo $ligne3;
								  echo $ligne4;
