     ...
     <div class="container">
            ...
            <div class="well well-lg col-xs-12 col-sm-12 col-md-offset-1 col-md-6">
                <ol class="phrases vertical encours">
                    <li value="4"><i class="fa fa-arrows"></i> <strong>Développement</strong> : votre conseiller commercial aura le privilège de...</li>
                    <li value="1"><i class="fa fa-arrows"></i> <strong>Objet</strong> : offre commerciale</li>
                    <li value="3"><i class="fa fa-arrows"></i> <strong>Rappel du contexte</strong> : faisant suite à...</li>
                    <li value="5"><i class="fa fa-arrows"></i> <strong>Remerciement</strong> : nous vous remercions pour...</li>          
                    <li value="6"><i class="fa fa-arrows"></i> <strong>Salutations</strong> : cordialement</li>
                    <li value="2"><i class="fa fa-arrows"></i> <strong>Formule d’appel</strong> : bonjour</li>  
                    <li value="7"><i class="fa fa-arrows"></i> <strong>Signature</strong> : service commercial</li>     
                </ol>
				<input type="text" id="ordre" hidden="hidden" name="reponse" /> 
			</div>
            <!--fin activité 2-->
            ...
            <div class="well well-lg">                            
								...
								<div class="col-md-3 col-xs-12">
                                    ...
                                    </span><label for="sentim1" class="form-control">À un proche </label></div>
								</div>
								<div class="col-md-3 col-xs-12"><div class=" input-group">
                                        <span class="input-group-addon">
                                        <input type="radio" name="sentim" id="sentim2" value="À des essionnels" />
                                    </span><label for="sentim2" class=" form-control">À des professionnels </label></div>
								</div>
								<div class="col-md-3 col-xs-12"><div class="input-group">
                                        <span class="input-group-addon">
