...
<html>
    <head>
		<title>Fiche 3 | Formation de l'Institut Français Algérie</title>
        <meta charset="utf-8">
		...
		<div class="container">
			<div class="well">
				...
				<div class="row">
					<div class="text-center well encadre col-xs-12 col-sm-offset-4 col-sm-4 col-sm-offset-4">
						<h3 class="remarque" style="font-size:2em">La société ne fait plus crédit!</h3>
					</div>
					<div class="text-center well encadre col-xs-12 col-sm-offset-1 col-sm-10 col-sm-offset-1">
						<h3 class="activite">Objectifs visés</h3>
            ...
            <!--BOITE MAIL-->
				...
				<div class="list-group-item">
					...
					<p><strong>Objet:</strong> Sollicitation d’un crédit</p>
					<div class="list-group-item">
						<p><strong>De :</strong>
							<span><a class="btn btn-primary btn-xs" href="#this" title="Répondre">
								<i class="fa fa-user fa-lg"></i> Moi</a>
							</span>
							<strong>À : </strong>Rachid HAMDI (rach.hamdi@fargo.dz)
						</p>
					</div>
				</div>
				<div class="list-group-item">
				...
				<p><i>Déplacez les phrases ci-dessous dans les bonnes cases :</i></p>
				...
				<div class="well well-lg">
					...
					<div class="row">
						<ol class="vertical col-xs-12 col-sm-6">
							<li>b. Je te prie de m’aider pour ...</li>
						</ol>
						<div class="btn-group col-md-6" data-toggle="buttons">
							<label class="btn btn-primary">
					...
					<div class="row">	
						<ol class="vertical col-xs-12 col-sm-6">
							<li>c. Réponds-moi stp sur ce sujet ...</li>
						</ol>
						<div class="btn-group col-md-6" data-toggle="buttons">
							<label class="btn btn-primary">
					...
					<div class="row">	
						<ol class="vertical col-xs-12 col-sm-6">
							<li>e. Je t’envoie le dossier en pj.</li>
						</ol>
						<div class="btn-group col-md-6" data-toggle="buttons">
							<label class="btn btn-primary">
					...
					<div class="row">	
						<ol class="vertical col-xs-12 col-sm-6">
							<li>f. Merci infiniment pour ton aide.</li>
						</ol>
						<div class="btn-group col-md-6" data-toggle="buttons">
							<label class="btn btn-primary">
