			...
			<div class="well">
				...
				<div class="row">
					<div class="text-center well encadre col-xs-12 col-sm-offset-4 col-sm-4 col-sm-offset-4">
						...
						<h3 class="remarque">Mohammed a choisi son modèle de voiture.</h3>
					</div>
					<div class="text-center well encadre col-xs-12 col-sm-offset-1 col-sm-10 col-sm-offset-1">
						<h3 class="activite">Objectifs</h3>
						<ul class="list-unstyled">
							<li><span class="fa fa-angle-double-right"></span> Conjuguer correctement le participe passé d’un verbe.</li>
							<li><span class="fa fa-angle-double-right"></span> Utiliser les termes adéquats pour compléter un message.</li>
							<li><span class="fa fa-angle-double-right"></span> Apprendre à bien structurer son courriel à l’aide de termes introducteurs d’idées.</li>
						</ul>
					</div>
				</div>
