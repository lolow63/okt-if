...
<html>
    <head>
		<title>Fiche 7 | Formation de l'Institut Français Algérie</title>
        <meta charset="utf-8">
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
			...
			<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
				<div class="container-fluid">
				  <div class="navbar-header">
					...
					<a class="navbar-brand" href="#">FICHE 7</a>
				  </div>
		...
		<div class="container">
			<div class="well">
				...
				<form method="post" action="../corriges/corrige7.php">
				...
				<div class="well">
					...
					<select name="f7a4q1" id="f7a4q1" class="form-control inline-form-control">
						<option value="" id="f7a4q1p0"></option>
					...
					<select name="f7a4q2" id="f7a4q2" class="form-control inline-form-control">
						<option value="" id="f7a4q2p0"></option>
					...
					<select name="f7a4q3" id="f7a4q3" class="form-control inline-form-control">
						<option value="" id="f7a4q3p0"></option>
					...
					<select name="f7a4q4" id="f7a4q4" class="form-control inline-form-control">
						<option value="" id="f7a4q4p0"></option>
					...
					<select name="f7a4q5" id="f7a4q5" class="form-control inline-form-control">
						<option value="" id="f7a4q5p0"></option>
