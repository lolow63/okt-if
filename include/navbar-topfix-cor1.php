    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse js-navbar-scrollspy">
        <ul class="nav navbar-nav">
          <li><a href="#top" class="fa fa-arrow-up"> HAUT DE LA PAGE</a></li>
          <li><a href="#bottom" class="fa fa-arrow-down"> BAS  DE LA PAGE</a></li>
		  <li><a href="#next" class="fa fa-step-forward"> FICHE SUIVANTE</a></li>
          <li class="dropdown">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-home fa-lg"></i><b class="caret"></b></a>
						...
						<li><a href="#aide" class="fa fa-question-circle"></a></li>
        </ul>
      </div>
    </div>
  </nav>
