...
<!--FIN BARRE DE NAVIGATION TOP-FIXE-->
		...
		<div class="container">
			<div class="well">
				...
				<p id="sujet" class="recoi">Titre de la fiche</p>
	...
	<div class="col-lg-12 col-xs-12">
		<p class="label-info label_activite">jyfutyfopiyoufy</p>
	</div>
	<div class="col-sm-4 col-xs-12">
		<input type="checkbox" id="faqp0" class="hidden" checked="checked" name="faq" value="Vous n'avez pas répondu" />
		<div class="input-group">
        	<span class="input-group-addon">
        		<input type="checkbox" id="faqp1" name="faq" value="" />
           	</span>
            <label for="faqp1" class="form-control">,vmxofkhfgpj</label>
       	</div>
	</div>
	<div class="col-sm-4 col-xs-12">
		<div class="input-group">
        	<span class="input-group-addon">
            	<input type="checkbox" id="faqp2" name="faq" value="" />
          	</span>
            <label for="faqp2" class="form-control">kjgjg</label>
      	</div>
	</div>
	<div class="col-sm-4 col-xs-12">
		<div class="input-group">
        	<span class="input-group-addon">
            	<input type="checkbox" id="faqp3" name="faq" value="" />
           	</span>
            <label for="faqp3" class="form-control">ygfiugpy</label>
       	</div>
	</div>
</div>
